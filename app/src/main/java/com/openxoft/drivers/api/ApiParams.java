...
public class ApiParams {
    ...
    public static final String ANOTHER_ACTIVITY ="another_activity";
    public static final String DEVICE_ID="device_id";



    public static final String TAG_DRIVER_LOGIN="driverguide";
    public static final String BASE_URL="http://app.opentours.com/AppsServices/";
    public static final String SUB_URL="AppsApi.aspx";
    public static final String KEY_TAG="tag";
    public static final String KEY_REQUEST="rq";
    ...
    public static final String KEY_TITLE_PAX="Pax";
    public static final String KEY_TITLE_STATUS="Status: ";
    public static final String KEY_TITLE_CONF="Confirmation No: ";
